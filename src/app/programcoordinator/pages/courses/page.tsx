...
export default function CourseStructurePage() {
    ...
    const goToPedagogyPage = (courseId: string) => {
        ...
        router.push(`/programcoordinator/pages/uploadcourseresources?${query}`);
    };
            ...
            renderCell: (structure: CourseStructure) => (
                <div className="flex gap-1 justify-center">
                    ...
                    >
                        ...
                        <span className="text-xs font-medium text-emerald-700 group-hover:text-emerald-800">Uploads Resourses</span>
                    </button>
